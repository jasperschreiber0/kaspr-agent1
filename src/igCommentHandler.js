 ...
 * Prompts for natural variation so repeated sends don't feel robotic.
 */
...
- Varies in tone and phrasing so it never sounds copy-pasted (imagine you're choosing randomly from 8 different ways to say the same thing)
...
/**
 * Sends a DM via Meta Graph API using the client's access token.
 */
async function sendIgDm({ accessToken, recipientId, message }) {
...
module.exports = { handleComment, sendIgDm };
